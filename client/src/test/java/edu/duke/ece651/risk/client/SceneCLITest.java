...
class SceneCLITest {
    ...
    static void beforeAll() throws IOException {
        ...
        territory1.addBasicUnits(1);
        territory2.addBasicUnits(2);
        territory3.addBasicUnits(3);
        territory4.addBasicUnits(4);
        territory5.addBasicUnits(5);
        territory6.addBasicUnits(6);
